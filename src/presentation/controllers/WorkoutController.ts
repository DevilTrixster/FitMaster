...
export class WorkoutController {
  ...
  async getHistory(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    const workouts = await this.workoutService.getCompletedWorkoutsHistory(
      userId, limit, offset, sortBy, sortOrder, dateFrom, dateTo, exerciseId, muscleGroup
    );
    const total = await this.workoutService.countCompletedWorkouts(userId, dateFrom, dateTo, exerciseId, muscleGroup);
  ...
  async getWorkoutDetails(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    const details = await this.workoutService.getWorkoutDetails(workoutId, userId);
    if (!details) {
